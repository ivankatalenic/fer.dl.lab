...
if __name__ == '__main__':
	...
	img_ax, ft_ax = fig.subplots(2)

	img_ax.scatter(test_img_rep2d[:, 0], test_img_rep2d[:, 1], color=colormap[Y[:]] / 255., s=5)
	img_ax.set_title("Image representation")
	...
	with torch.no_grad():
		...
		ft_ax.scatter(test_rep2d[:, 0], test_rep2d[:, 1], color=colormap[Y[:]] / 255., s=5)
		ft_ax.set_title("Feature representation")
